namespace GameCreator.UIComponents
{
	...
	[AddComponentMenu("")]
	public class ActionScaleElement : IAction
	{
        ...
        public override IEnumerator Execute(GameObject target, IAction[] actions, int index)
        {
	        ...
	        objectTransform = elementtoScale.GetComponent<Transform>();
		...
		public static new string NAME = "UI/Elements/Scale UI Element";
		private const string NODE_TITLE = "Scale UI Element";
		...
		protected override void OnEnableEditorChild ()
		{
			...
			this.spScaleObject = this.serializedObject.FindProperty("elementtoScale"); 
        ...
        public override void OnInspectorGUI()
		{
			...
			EditorGUILayout.PropertyField(this.spScaleObject, new GUIContent("Element"));
            EditorGUILayout.Space();
			EditorGUILayout.LabelField(new GUIContent("Axis to Scale"));
            ...
            EditorGUILayout.Space();
            EditorGUI.indentLevel--;
			EditorGUILayout.PropertyField(this.spScaleObjectSpeed, new GUIContent("Time to resize"));
            EditorGUILayout.Space();
			EditorGUILayout.PropertyField(this.spreturnTo, new GUIContent("Return Element"));
            EditorGUILayout.Space();
            EditorGUI.indentLevel++;
