namespace PivecLabs.ActionPack
{
	...
	public class ActionDragObjecttoRotateonZ : IAction
	{
			...
			if ((objectToDrag != null) && (dragging == true))

					{
						...
						if (Input.GetMouseButton(mouseButton))
						{
							...
							{
							case AXIS.xAxis:
								speed = new Vector3(0, 0, mouseDelta.x * _zMultiplier);
								break;

							case AXIS.yAxis:
								speed = new Vector3(0, 0, mouseDelta.y * _zMultiplier);
								break;
							}
						...
						if (speed != Vector3.zero)
						{
							...
							{
							case AXIS.xAxis:
								objectToDrag.transform.Rotate(0, 0, speed.z * dragSpeed);
								break;
		...
		public static new string NAME = "ActionPack1/Objects/Drag Object to Rotate on zAxis";
		private const string NODE_TITLE = "Drag Object to Rotate on zAxis";
		...
		public override void OnInspectorGUI()
	{
		this.serializedObject.Update();
			...
			EditorGUILayout.PropertyField(this.spallowDragging, new GUIContent("Allow Dragging of Z Axis"));
