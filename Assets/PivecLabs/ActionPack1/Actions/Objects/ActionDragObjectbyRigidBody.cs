namespace PivecLabs.ActionPack
{
	...
	public class ActionDragObjectbyRigidBody : IAction
	{
		...
		public bool allowRBDragging;
		public bool allowRBDrag;
		...
		void Update()
		{
			...
			if (allowRBDrag == true & objectToDrag)
			{
		...
		public static new string NAME = "ActionPack1/Objects/Drag Object by Rigid Body";
		...
		protected override void OnEnableEditorChild()
		{
			...
			this.spallowDragging = this.serializedObject.FindProperty("allowRBDragging");
		...
		public override void OnInspectorGUI()
		{
			...
			EditorGUILayout.PropertyField(this.spallowDragging, new GUIContent("Allow RB Dragging"));
			EditorGUILayout.Space();
			if (allowRBDragging == true)
			{
