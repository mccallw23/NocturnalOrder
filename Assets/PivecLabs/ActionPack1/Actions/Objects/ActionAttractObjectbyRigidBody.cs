namespace PivecLabs.ActionPack
{
	...
	[AddComponentMenu("")]
	public class ActionAttractObjectbyRigidBody : IAction
	{
        ...
        public override bool InstantExecute(GameObject target, IAction[] actions, int index)
		{
			...
			if (targetRB != null)
			{
				intensity = Vector3.Distance(gravityGO.transform.position, targetGO.transform.position);
		...
		public static new string NAME = "ActionPack1/Objects/Attract Object with RigidBody";
		private const string NODE_TITLE = "Attract Object with RigidBody";
        ...
        public override void OnInspectorGUI()
		{
			...
			EditorGUILayout.PropertyField(this.spTarget2, new GUIContent("Attracting Game Object")); 
