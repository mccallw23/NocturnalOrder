namespace PivecLabs.ActionPack
{
	...
	public class ActionDragAnyObjectbyTag : IAction
	{
			...
			if (allowDrag == true)
			{
				if (Input.GetMouseButtonDown(mouseButton))
				{
					...
					if(Physics.Raycast (ray,out hit, 100.0f))
					{
						...
						if (hit.transform.gameObject.tag == this.tagName)
						{
		...
		public static new string NAME = "ActionPack1/Objects/Drag Any Object by Tag";
		private const string NODE_TITLE = "Drag Any Object by Tag";
		public const string CUSTOM_ICON_PATH = "Assets/PivecLabs/ActionPack1/Icons/";

		// PROPERTIES: ----------------------------------------------------------------------------

		private SerializedProperty spobjectTag;
		...
		{
			this.spobjectTag = this.serializedObject.FindProperty("tagName");
		...
		public override void OnInspectorGUI()
		{
			...
			EditorGUILayout.PropertyField(this.spobjectTag, new GUIContent("Object Tag"));
